 ...
 "cells": [
  {
   "cell_type": "code",
   "execution_count": 24,
   "id": "31ada911-e81f-4d5b-b75a-5f1163214a33",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 25,
   "id": "26cc6e7c-2433-40b1-9d55-0c0f3fe79c73",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 26,
   "id": "6efe9e11-e629-464a-937e-651d7c92d912",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 27,
   "id": "bdac9e29-04c8-4063-beaf-bce0773efee5",
   "metadata": {},
   "outputs": [],
   "source": [
    "#set the input data (including all 8 features)\n",
    "MedInc = 5.0  # Median Income (in $10,000s)\n",
    "HouseAge = 20  # House Age (in years)\n",
    "AveRooms = 6  # Average Rooms\n",
    "AveOccup = 3  # Average Occupants\n",
    "Latitude = 33.5  # Latitude\n",
    "Longitude = -118.5  # Longitude\n",
    "MedVal = 2.0  # Median House Value (in $100,000s)\n",
    "AveHouseValue = 5.0  # Placeholder for missing feature (set a value for prediction)\n",
    "\n",
    "#prepare the input data for prediction (including 8 features)\n",
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "The predicted house price is: $150495.66\n"
     ]
    }
   ],
   "source": [
    ...
    "print(f\"The predicted house price is: ${prediction[0] * 100000:.2f}\")\n"
   ]
  },
  {
   "cell_type": "code",
